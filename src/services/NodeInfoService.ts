/**
 * NodeInfo Service
 * Provides instance metadata for federation discovery
 * Implements NodeInfo 2.1 protocol
 *
 * Reference: https://nodeinfo.diaspora.software/protocol
 */
...
/**
 * Count public posts (blog + notes)
 * Uses configurable content directory
 */
...
/**
 * Count local comments (future implementation)
 */
...
/**
 * Get NodeInfo 2.0 (backwards compatible)
 */
